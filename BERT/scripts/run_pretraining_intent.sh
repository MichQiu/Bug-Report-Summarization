...
warmup_proportion_phase2=${18:-"0.064"}
train_steps_phase2=${19:-1563}
gradient_accumulation_steps_phase2=${20:-512}
DATASET=intent/phase1 # change this for other datasets
DATA_DIR_PHASE1=${21:-$BERT_PREP_WORKING_DIR/${DATASET}/}
BERT_CONFIG=bert_config_intent.json
DATASET2=intent/phase2 # change this for other datasets
DATA_DIR_PHASE2=${22:-$BERT_PREP_WORKING_DIR/${DATASET2}/}
CODEDIR=${23:-"/workspace/bert"}
init_checkpoint=${24:-"None"}
RESULTS_DIR=$CODEDIR/results/intent
CHECKPOINTS_DIR=$RESULTS_DIR/checkpoints/intent
...
CMD+=" --max_predictions_per_seq=40"
