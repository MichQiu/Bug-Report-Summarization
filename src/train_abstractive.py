...
def validate(args, device_id, pt, step):
    ...
    tokenizer = BertTokenizer(args.vocab, do_lower_case=False)
    symbols = {'BOS': tokenizer.vocab['上'], 'EOS': tokenizer.vocab['下'],
               'PAD': tokenizer.vocab['[PAD]'], 'EOQ': tokenizer.vocab['中']}
